...
\geometry{
	hmargin=0.5cm, % Horizontal margin
	vmargin=0.5cm, % Vertical margin
...
\titlespacing{\section}{0pt}{0pt}{4pt} % Spacing around section titles, the order is: left, before and after
...
\newcommand{\workposition}[6]{
	...
	\expandafter\ifstrequal\expandafter{#6}{}{}{}{#6\\} 
}
%Command for education
\newcommand{\education}[5]{
	{\raggedleft\textsc{#1}\par} % Duration and conditional full time/part time text
	\expandafter\ifstrequal\expandafter{#2}{}{}{}{{\raggedright\large #2}\\}  %Description
	\expandafter\ifstrequal\expandafter{#3}{}{}{}{\raggedright\large\textit{\textbf{#3}}\\}
...
\newcommand{\educationentry}[6]{
	...
	\expandafter\ifstrequal\expandafter{#6}{}{}{& \textit{#6}\\}
}
